...
exports.list_collection = function (req, res) {
  ...
  MongoClient.connect(req.body.localdb)
    .then((client) => {
...
exports.collection_ana_code = function (req, res) {
  var mfile = req.body.mfile;
  // const databasename = "centrixdb_demo";
...
exports.collection_ana_name = function (req, res) {
  var mfile = req.body.mfile;
  // const databasename = "centrixdb_demo";
...
exports.updateordercat = function (req, res) {
  var mfile = req.body.mfile;
  MongoClient.connect(req.body.localdb, (connectErr, db) => {
    if (req.body != null) {
      var dbo = db;
      dbo
        .collection(mfile)
